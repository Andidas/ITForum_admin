...
document.write('<link rel="stylesheet" type="text/css" href="'+getRootPath()+'/css/theme.css">');
document.write('<link rel="stylesheet" href="'+getRootPath()+'/lib/font-awesome/css/font-awesome.css">');
